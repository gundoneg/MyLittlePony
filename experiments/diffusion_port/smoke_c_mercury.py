"""CPU smoke: exec c_mercury_port.ipynb code cells with tiny params against the local
...
repl = {
    ...
    r"DONOR_STEPS = 1200": "DONOR_STEPS = 4",
    ...
    r"def masked_ce_at\(forward_fn, ids, t_val, n=32\)": "def masked_ce_at(forward_fn, ids, t_val, n=2)",
