...
"",
"def finetune_diffusion(w_init, mask_init, steps=WARM_STEPS, every=WARM_EVERY, snap_at=None):",
...
"            snap = ({k: v.detach().clone() for k, v in w.items()}, mr.detach().clone())",
"        if s == steps: break",
...
"",
"t0 = time.time()",
"curve_B, snapB = finetune_diffusion(wB, mrow, snap_at=100)  # warm from the translation",
"curve_F, _ = finetune_diffusion(supra, mean_row)            # warm from the raw floor",
